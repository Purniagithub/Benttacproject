        ...
        {dishes.map((dish) => (
          <div key={dish.id} className="text-center max-w-[180px] mx-auto">
            <img
              src={dish.img}
              alt={dish.name}
              className="w-20 h-20 md:w-28 md:h-28 object-cover rounded-full mx-auto border-4 border-white shadow-lg"
            />
            <h3 className="mt-2 font-semibold text-base md:text-lg">{dish.name}</h3>
