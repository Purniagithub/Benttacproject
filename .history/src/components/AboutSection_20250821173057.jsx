  ...
  return (
    <section className="w-full bg-white py-16">
      <div className="max-w-5xl mx-auto text-center">
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-8 mt-16 pt-10">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">A small river named Duden flows by their place and supplies it
              with the necessary regelialia. It is a paradisematic country, in
