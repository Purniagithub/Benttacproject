...
const Hero = () => {
  return (
    <section
      className="relative h-[70vh] bg-cover bg-center relative flex flex-col justify-center items-center text-white"
    ...
    >
      ...
      {/* Dish Cards */}
      <div className="relative z-10 flex justify-center space-x-12 mt-20">
        {dishes.map((dish) => (
