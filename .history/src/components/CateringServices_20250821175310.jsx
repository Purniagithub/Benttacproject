  ...
  return (
    <section id={id} className="relative isolate bg-white py-24 sm:py-28">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-x-0 -top-1 sm:top-0 text-center">
        <span className="select-none font-serif italic tracking-tighter text-amber-800/40 text-7xl sm:text-8xl md:text-[96px] leading-none">
          {accent}
        </span>
      </div>

      <div className="mx-auto max-w-[1200px] px-4 -mt-14">
        {/* Main heading */}
