...
const AV1 = "/images/testi-1.jpg";
const AV2 = "/images/testi-2.jpg";
const AV3 = "/images/testi-3.jpg";
...
function Accent({ text, className = "" }) {
  return (
    <div aria-hidden className={`pointer-events-none absolute inset-x-0 -top-4 text-center ${className}`}>
      <span className="select-none font-serif italic text-amber-900/25 leading-none tracking-wide text-[54px] sm:text-[64px]">
        {text}
      </span>
    </div>
  );
...
function ReservationCard() {
  return (
    <div className="relative mx-auto w-[640px] max-w-[92vw] rounded bg-white/98 p-6 shadow-lg">
