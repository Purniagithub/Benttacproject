...
const BG_IMG = "/dish-13.jpg";          // full-width background for reservation
...
function Accent({ text, className = "" }) {
  return (
    <div aria-hidden className={`pointer-events-none absolute inset-x-0 -top-4 text-center ${className}`}>
      <span className="select-none font-serif italic text-amber-900/25 leading-none tracking-wide text-[54px] sm:text-[64px] mt-0">
        {text}
      </span>
    </div>
  );
