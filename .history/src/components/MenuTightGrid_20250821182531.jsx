...
const tiles = [
  ...
  // Row 2
  { type: "card",  title: "Grilled Beef\nwith potatoes", price: 29, lines: ["Meat, Potatoes, Rice,", "Tomatoe"] },
  { type: "image", src: "/dish-3.jpeg", alt: "Dish 3" },
  { type: "card",  title: "Grilled Beef\nwith potatoes", price: 29, lines: ["Meat, Potatoes, Rice,", "Tomatoe"] },
  { type: "image", src: "/dish-4.jpeg", alt: "Dish 5" },
  // Row 3
  { type: "image", src: "/dish-5.jpeg", alt: "Dish 6" },
  { type: "card",  title: "Grilled Beef\nwith potatoes", price: 29, lines: ["Meat, Potatoes, Rice,", "Tomatoe"] },
  { type: "image", src: "/dish-6.jpeg", alt: "Dish 6" },
  { type: "card",  title: "Grilled Beef\nwith potatoes", price: 29, lines: ["Meat, Potatoes, Rice,", "Tomatoe"] },
];
  ...
  return (
    <section id={id} className="relative isolate bg-white py-14">
      ...
      <div className="mx-auto px-4" style={{ maxWidth: `${containerWidth}px` }}>
        <h2 className="text-center text-[30px] md:text-[34px] font-extrabold leading-tight text-zinc-900 -mt-12">
          {heading}
        </h2>
