...
/* Accent (for other sections if needed) */
  ...
  return (
    <div className="relative w-[540px] max-w-[92vw] rounded bg-white p-6 shadow-xl">
      ...
      <div className="relative text-center mb-3">
        ...
        <h2 className="-mt-8 text-[30px] sm:text-[34px] font-bold text-zinc-900">
          Make Reservation
        </h2>
      </div>
...
export default function ReservationTestimonials() {
  return (
    <section className="bg-white">
      ...
      >
        {/* Keep your container and alignment */}
        <div className="relative mx-auto max-w-[980px] px-4 py-20 sm:py-24">
          {/* Remove outside headings; keep card headings inside the card */}
      ...
      <div className="relative mx-auto max-w-[980px] px-4 py-20 sm:py-24">
        ...
        {/* Cards scrollable on small; grid on larger screens */}
