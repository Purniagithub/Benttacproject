...
export default function CateringServices({
  ...
  return (
    <section id={id} className="relative isolate bg-gray-50 py-24 sm:py-28">
      {/* Accent word behind heading */}
      <div aria-hidden className="pointer-events-none absolute inset-x-0 -top-1 sm:top-0 text-center">
        <span className="select-none font-serif italic tracking-wide text-amber-900/15 text-7xl sm:text-8xl md:text-[96px] leading-none">
          {accent}
        </span>
      </div>
      ...
      <div className="mx-auto max-w-[1200px] px-4">
        {/* Main heading */}
        <h2 className="text-center text-[34px] sm:text-[38px] md:text-[44px] font-extrabold tracking-tight text-zinc-900 -mt-12">
          {heading}
        </h2>
